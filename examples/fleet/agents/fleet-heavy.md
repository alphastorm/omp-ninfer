---
name: fleet-heavy
description: Long-context background worker on the RTX 4090 lane (ninfer-heavy/qwen3.8-27b): bounded multi-step implementation or analysis packets that need the full 131,072-token window and can run while the lead keeps working on the RTX 5090. One active request; fails closed if the lane is offline.
tools: read, grep, glob, edit, write, bash
model: ninfer-heavy/qwen3.8-27b:medium
