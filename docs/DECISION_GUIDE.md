...
The v0.8.2 scope is **RTX 5090 on Windows 11 + Docker Desktop/WSL2** or **RTX 4090 native
Windows 11**, with the checksummed, unmodified upstream OMP 18.3.0 binary.
[Release state and manifest](RELEASES.md).
RTX 3090 is deferred for v0.8.2; its [historical v0.7.2 route](https://github.com/alphastorm/omp-ninfer/blob/v0.7.2/docs/QUICKSTART.md)
