...
Last verified: 2026-09-11 · Current stable release: **v0.6.4**

Everything on this page is bound to the [v0.6.4 release manifest](../releases/v0.6.4/manifest.json)
...
| RTX 3090 | native Windows service | 131,072 | durable v0.2.5-beta.1 lane (origin-authenticated checkpoints, bound by v0.6.4) |
