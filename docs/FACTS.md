...
Last verified: 2026-09-12 · Current stable release: **v0.6.5**

Everything on this page is bound to the [v0.6.5 release manifest](../releases/v0.6.5/manifest.json)
...
| RTX 3090 | native Windows service | 131,072 | durable v0.2.5-beta.1 lane (origin-authenticated checkpoints, bound by v0.6.5) |
