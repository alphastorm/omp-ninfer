...
| Durable session checkpoints → process-restart continuation | Every v0.3.0 lane binds a passing restart gate: 102K restored continuation on RTX 4090, 310 MB checkpoint restoration on RTX 3090, and the fresh RTX 5090 receipt | released on all three lanes |
