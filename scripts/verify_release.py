...
NINFER_RELEASE_TAG_RE = re.compile(
    r"^v(?:0\.2\.0|0\.3\.0|0\.4\.0|0\.4\.1|0\.4\.3|0\.4\.4|0\.4\.5)-qwen38-5090-beta\.[1-9][0-9]*$"
)
NINFER_VARIANT_RELEASE_TAG_RES = {
    "rtx3090-windows-native": re.compile(
        r"^v(?:0\.2\.0-qwen38-3090-beta\.[1-9][0-9]*|0\.3\.0-qwen38-3090\.1|0\.2\.2-qwen38-3090-beta\.[1-9][0-9]*)$"
    ),
...
NINFER_VARIANT_PACKAGE_NAME_RES = {
    "rtx3090-windows-native": re.compile(
        ...
        r"0\.2\.2-beta\.1-windows-x86_64-cuda13\.3)-rtx3090\.tar\.gz$"
    ),
    "rtx4090-windows-native": re.compile(
