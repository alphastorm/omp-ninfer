...
**[Download v0.3.1](https://github.com/alphastorm/omp-ninfer/releases/latest)** · **[Choose your lane](docs/QUICKSTART.md#choose-your-lane)** ·
...
[`qualification.json`](releases/v0.3.1/qualification.json):
...
All three lanes are qualified releases in the v0.3.1 manifest, each bound to its exact package,
