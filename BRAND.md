...
- Status grammar: when lane status is stated, write **"Qualified on RTX 5090 · 4090 · 3090"**.
  When install authority matters, bind it to the current ready release (`v0.4.8`) instead of
...
**[Download v0.4.8](https://github.com/alphastorm/omp-ninfer/releases/latest)** ·
