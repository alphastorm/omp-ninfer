...
- Status grammar: when lane status is stated, write **"Qualified on RTX 5090 · 4090 · 3090"**.
  When install authority matters, bind it to the current ready release (`v0.4.6`) instead of
...
**[Download v0.4.6](https://github.com/alphastorm/omp-ninfer/releases/latest)** ·
